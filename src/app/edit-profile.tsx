          ...
          onPress: async () => {
            ...
            try {
              ...
              if (e.code === "auth/requires-recent-login") {
                Alert.alert(
                  "Akses Ditolak",
                  "Demi keamanan, silakan keluar dari akun lalu masuk kembali sebelum menghapus akun.",
                );
              } else {
      ...
      >
        ...
        >
          <AnimatedPress onPress={pickImage} style={styles.avatarContainer}>
            ...
            <View
              style={[styles.editAvatarButton, { borderColor: getBgColor() }]}
            >
        ...
        <Animated.View
          ...
          style={[styles.formCard, { backgroundColor: getCardBg() }]}
        >
          <View style={styles.inputGroup}>
            <Text style={[styles.label, { color: getMutedColor() }]}>
              Nama Lengkap
            </Text>
            <TextInput
              style={[
        ...
        <Animated.View entering={FadeInDown.delay(200).duration(400)}>
          <AnimatedPress
            style={[
              styles.deleteBtn,
              { borderColor: Semantic.danger.main, borderWidth: 1 },
            ]}
            onPress={handleDeleteAccount}
          >
            <Feather name="trash-2" size={18} color={Semantic.danger.main} />
            <Text
              style={[styles.deleteBtnText, { color: Semantic.danger.main }]}
            >
              Hapus Akun Permanen
            </Text>
          </AnimatedPress>
