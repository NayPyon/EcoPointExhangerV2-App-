...
export default function ForgotPasswordScreen() {
  ...
  const handleReset = async () => {
    ...
    try {
      ...
      setSuccessMsg(
        "Tautan untuk mengatur ulang kata sandi telah dikirim ke email kamu.",
      );
    } catch (error: any) {
      console.error(error);
      ...
      >
        <ScrollView
          contentContainerStyle={[
            ...
            { paddingTop: Math.max(insets.top + Spacing.xl, Spacing.xxxl * 2) },
          ]}
        ...
        >
          ...
          >
            {errorMsg && (
              ...
              >
                ...
                />
                <Text
                  style={[styles.alertText, { color: Semantic.danger.main }]}
                >
                  {errorMsg}
                </Text>
              </View>
            ...
            {successMsg && (
              ...
              >
                ...
                />
                <Text
                  style={[styles.alertText, { color: Semantic.primary.main }]}
                >
                  {successMsg}
                </Text>
              </View>
          ...
          >
            <AnimatedPress onPress={() => router.back()} style={styles.backBtn}>
              ...
              <Text style={[styles.backText, { color: getMutedColor() }]}>
                Kembali ke Login
              </Text>
            </AnimatedPress>
          </Animated.View>
