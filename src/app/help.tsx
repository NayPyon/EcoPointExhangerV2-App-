...
const FAQS = [
  {
    ...
    answer:
      "Kamu bisa menukarkan poin di halaman 'Reward'. Pilih voucher yang kamu inginkan, lalu klik 'Tukar Poin'. Pastikan saldo poinmu cukup ya!",
  },
  {
    question: "Di mana saya bisa menyetor sampah?",
    answer:
      "Kamu bisa menyetor botol plastik dan kaleng logam di mesin RVM (Reverse Vending Machine) EcoPoint yang tersebar di berbagai titik stasiun dan mall.",
  },
  {
    question: "Berapa poin yang didapat per botol?",
    answer:
      "Saat ini, 1 botol plastik bernilai 100 poin, dan 1 kaleng logam bernilai 300 poin.",
  },
  {
    question: "Mengapa akun saya ter-logout sendiri?",
    answer:
      "Untuk alasan keamanan, sesi akun akan berakhir jika tidak ada aktivitas selama 30 hari. Silakan login kembali menggunakan email kamu.",
  },
];
...
export default function HelpCenterScreen() {
  ...
  const getBorderColor = () =>
    isDark ? Colors.obsidian[700] : Semantic.border.light;
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        >
          ...
          <View style={styles.contactText}>
            ...
            <Text style={[styles.contactDesc, { color: getMutedColor() }]}>
              Tim kami siap membantu kendala kamu 24/7.
            </Text>
          </View>
          <AnimatedPress
        ...
        <Animated.Text
          ...
          style={[styles.sectionTitle, { color: getTextColor() }]}
        >
          Pertanyaan Populer
        </Animated.Text>
            ...
            return (
              ...
              >
                <View style={styles.faqHeader}>
                  <Text style={[styles.faqQuestion, { color: getTextColor() }]}>
                    {faq.question}
                  </Text>
                  <Feather
                ...
                {isExpanded && (
                  <Text style={[styles.faqAnswer, { color: getMutedColor() }]}>
                    {faq.answer}
                  </Text>
                )}
              </AnimatedPress>
